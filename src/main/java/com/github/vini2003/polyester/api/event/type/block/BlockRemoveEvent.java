...
public class BlockRemoveEvent {
	public interface Listener {
		EventResult receive(World world, Optional<BlockEntity> blockEntity, BlockInformation data, boolean moved);
	}
	...
	public static EventResult dispatch(World world, Optional<BlockEntity> blockEntity, BlockInformation data, boolean moved) {

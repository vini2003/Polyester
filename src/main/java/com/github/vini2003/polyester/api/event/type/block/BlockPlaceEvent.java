...
public class BlockPlaceEvent {
	public interface Listener {
		EventResult receive(World world, Optional<LivingEntity> placer, BlockInformation data, ItemStack stack);
	}
	...
	public static EventResult dispatch(World world, Optional<LivingEntity> placer, BlockInformation data, ItemStack stack) {

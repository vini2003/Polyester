package com.github.vini2003.polyester.api.dimension.implementation;

import com.github.vini2003.polyester.api.dimension.DimensionSettings;
 ...
 */
public class DimensionImplementation extends Dimension {
	private final DimensionType type;
	private DimensionState state;
	private DimensionSettings settings;

	public DimensionImplementation(World world, DimensionType type, DimensionSettings settings) {
		super(world, type, 15);
		this.type = type;
